...
void Shader::Compile(const char* vertexSource, const char* fragmentSource)
{
    ...
    //Error Check
    checkShaderErrors(sVertex, "VERTEX");
    checkShaderErrors(sFragment, "FRAGMENT");
...
void Shader::checkShaderErrors(unsigned int shader, std::string type)
{
    ...
    if (!compileResult) {
        ...
        Debug::Error("Failed to compile shader" + type + ". Error: " + shaderString, "Shader.cpp", __LINE__);
    }
}
...
void Shader::checkProgramErrors(unsigned int program)
{
    ...
    if (!compileResult)
    {
        ...
        Debug::Error("Failed to link program. Error: " + programString, "ShaderHandler.cpp", __LINE__);
